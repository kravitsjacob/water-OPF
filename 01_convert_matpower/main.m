...
pathto_case_info = fullfile('G:\My Drive\Documents (Stored)\data_sets\Generator Matching V1_io\input', 'case_info.csv');
pathto_case_export = fullfile('G:\My Drive\Documents (Stored)\data_sets\Generator Matching V1_io\input', 'case.mat');
